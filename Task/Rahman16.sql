drop database Rahman_22038;
create database Rahman_22038;
use Rahman_22038;
...
INSERT INTO `department` (`dept_id`, `dname`, `doctorname`, `headname`, `phone`) VALUES (11, 'Cancer', 'Watson', 'krishna', '9796959493');
INSERT INTO `department` (`dept_id`, `dname`, `doctorname`, `headname`, `phone`) VALUES (8, 'Cancer', 'Teri', 'krishna', '9796959493');
INSERT INTO `department` (`dept_id`, `dname`, `doctorname`, `headname`, `phone`) VALUES (6, 'Cancer', 'House', 'krishna', '9796959445');
...
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (1088, 'P.Anurag', 'MBBS', '09/08/1983', 25000, 'Subramanyam', 'anurag@gmail.com', 8, 22, '123456');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (1022, 'S.Sumanth Mohan', 'MBBS', '14/3/1974', 14500, 'Mohan', 'sumanth@gmail.com', 3, 35, '123456');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (1077, 'V.Prasad', 'MBBS', '29/10/1980', 22000, 'Venkat', 'prasad@gmailcom', 7, 12, 'camel');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (3333, 'S Khan', 'MBBS FRCS', '2/2/1976', 50000, 'Y Khan', 'skhan@gmail.com', 1, 8, 'frog');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (7777, 'HariGK', 'MBBS', '1-1-1980', 5000, '', 'hari@gmail.com', 1, 0, '123456');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (7778, 'HariGKE', 'MBBS', '1-1-1980', 5000, null, 'hari2@gmail.com', 1, 5, '123456');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (1044, 'K.Karun Kumar', 'MBBS', '20/1/1973', 20000, 'Srinivas', 'karun@gmailcom', 5, 0, '123456');
INSERT INTO `doctor` (`doc_id`, `name`, `qualification`, `dob`, `salary`, `relative`, `emailid`, `departmentid`, `patientcount`, `pass`) VALUES (6887, 'Kranthi', 'MBBS', '4-1-1980', 25000, 'tyu', 'tyu@tyu.com', 1, 6, '1234');
# 8 records
